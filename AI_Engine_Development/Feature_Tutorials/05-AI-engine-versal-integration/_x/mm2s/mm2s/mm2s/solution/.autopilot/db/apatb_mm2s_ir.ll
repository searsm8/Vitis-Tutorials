; ModuleID = '/home/msears/Vitis-Tutorials/AI_Engine_Development/Feature_Tutorials/05-AI-engine-versal-integration/_x/mm2s/mm2s/mm2s/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mm2s_ir(%"struct.ap_int<32>"* noalias nocapture nonnull readonly %mem, %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mm2s_hw(%"struct.ap_int<32>"* %mem_copy, i32* %s_copy.data, i4* %s_copy.keep, i1* %s_copy.last, i32 %size)
...
declare void @apatb_mm2s_hw(%"struct.ap_int<32>"*, i32*, i4*, i1*, i32)
...
define void @mm2s_hw_stub_wrapper(%"struct.ap_int<32>"*, i32*, i4*, i1*, i32) #6 {
entry:
  ...
  call void @mm2s_hw_stub(%"struct.ap_int<32>"* %0, %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* %5, i32 %4)
  call void @copy_in(%"struct.ap_int<32>"* null, %"struct.ap_int<32>"* %0, %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"* %5, i32* %1, i4* %2, i1* %3)
  ret void
}

declare void @mm2s_hw_stub(%"struct.ap_int<32>"*, %"class.hls::stream<qdma_axis<32, 0, 0, 0>, 0>"*, i32)
